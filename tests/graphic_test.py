...
class GraphicContainerTestCase(unittest.TestCase):
    """Test for GraphicContainer"""

    def test_init_graphic_con(self):
    ...
    def test_init_graphic_con_vertex_based(self):
    ...
    def test_init_graphic_con_legend_parameters(self):
